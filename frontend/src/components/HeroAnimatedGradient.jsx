...
function StatItem({ stat, index, startCount }) {
  ...
  return (
    ...
    >
      ...
      <span className="text-sm md:text-base text-slate-400 font-medium mt-1 text-center">
        {stat?.label}
      </span>
    </motion.div>
  );
...
export default function HeroAnimatedGradient() {
  ...
  const MessageCircleIcon =
    Icons['MessageCircle'] || Icons['HelpCircle'];
      ...
      >
        ...
        >
          <motion.span
            ...
            style={{
              backgroundImage:
                'linear-gradient(135deg, #59bfff 0%, #d4b5fd 35%, #ffdaf3 55%, #59bfff 80%, #d4b5fd 100%)',
          ...
          <motion.span
            ...
            style={{
              backgroundImage:
                'linear-gradient(135deg, #ffdaf3 0%, #d4b5fd 40%, #59bfff 70%, #ffdaf3 100%)',
              backgroundSize: '300% 300%',
            }}
          >
            Define Brands.
        ...
        >
          VELORA crafts world-class digital strategies,
          design systems, and technology solutions
        ...
        >
          <motion.a
            ...
            whileHover={{
              scale: 1.04,
              boxShadow:
                '0 0 32px 4px rgba(89,191,255,0.28)',
            }}
            whileTap={{ scale: 0.97 }}
            transition={{
              type: 'spring',
            ...
            style={{
              background:
                'linear-gradient(135deg, #59bfff 0%, #d4b5fd 100%)',
              boxShadow:
                '0 4px 24px 0 rgba(89,191,255,0.22)',
            }}
          >
            See Our Work
          ...
          <motion.a
            href="https://wa.me/919258903072?text=Hello%20VELORA%2C%20I%20found%20VELORA%20online%20and%20I%20want%20to%20learn%20more%20about%20your%20services."
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{
              scale: 1.04,
              borderColor: 'rgba(89,191,255,0.7)',
            }}
            whileTap={{ scale: 0.97 }}
            transition={{
              type: 'spring',
      ...
      >
        <div
          ...
          style={{
            ...
            boxShadow:
              '0 8px 40px 0 rgba(89,191,255,0.10)',
          }}
        >
          {STATS.map((stat, i) => (
            <StatItem
